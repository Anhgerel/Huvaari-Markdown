...
inquirer
  ...
  .then((answers) => {
    ...
    if (!fs.existsSync('data/huvaari')) fs.mkdirSync('data/huvaari', { recursive: true })
    const filePath = `data/huvaari/${fileName ? fileName : 'untitled'}.${answers.extension ? answers.extension : 'md'}`
